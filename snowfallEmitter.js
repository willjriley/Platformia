function SnowfallEmitter(x, y, color1, color2, density, count, emissionSpeed = 0.5) {
    this.x = x;
    this.y = y;
    this.color1 = color1;
    this.color2 = color2;
...
SnowfallEmitter.prototype.createParticle = function () {
    return {
...
SnowfallEmitter.prototype.update = function () {
...
SnowfallEmitter.prototype.draw = function (ctx, camera) {
    ctx.save();
