function PortalEmitter(x, y, color1, color2, density, count, emissionSpeed = 1) {
    this.x = x;
    this.y = y;
    this.color1 = color1;
    this.color2 = color2;
...
PortalEmitter.prototype.createParticle = function () {
...
PortalEmitter.prototype.update = function () {
...
PortalEmitter.prototype.draw = function (ctx, camera) {
    ctx.save();
